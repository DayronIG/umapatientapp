...
export default function FrequentQuestions({goBack}) {
    const qa = [
        ...
        {
            question: "¿Cuáles son las ventajas de hacer un test rápido ?",
            answer: ["Servicio de logística puerta a puerta con vehículos identificados, conductores profesionales y profesionales de la salud propios.","Es rápido. Con resultados en 15/20 minutos.",
            "Accesible." ,
