...
const GenericChart = props => {
    ...
    return (
        <div className="genericChart">
            <div className="title">Colesterol</div>
            <div className="arrowContainer">
                <div className="itemsContainer" >
                    <div className="arrowStatus" style={{ position: 'absolute', left: Valor, color: color }} >{Total}</div>
                    <br></br>
                    <div className="arrowItem" style={{ position: 'absolute', left: Valor }}>
